...
def set_params(min_size, inflation_size, static_threshold,speed_threshold):  # set param by changing the yaml file
...
def objective_func(min_size, inflation_size, static_threshold,speed_threshold):
    global max_dist

    # set params
    set_params(min_size, inflation_size, static_threshold,speed_threshold)
