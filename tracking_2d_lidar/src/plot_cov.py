...
class EstimationError:
    ...
    def plot(self, data_1=None, data_2=None, data_3=None, data_4=None):
        ...
        if data_1 != None:
            self.ax_1.cla()
            self.ax_1.grid()
            self.ax_1.set_ylabel(r'${\bf P}_{xx}$', fontsize=18)
        ...
        if data_2 != None:
            self.ax_2.cla()
            self.ax_2.grid()
            self.ax_2.set_ylabel(r'${\bf P}_{yy}$', fontsize=18)
        ...
        if data_3 != None:
            self.ax_3.cla()
            self.ax_3.grid()
            self.ax_3.set_ylabel(r'${\bf P}_{{V_x}{V_x}}$', fontsize=18)
            # self.ax_3.plot(np.asarray(self.t), np.asarray(self.data_3), '-bx')
            # self.ax_3.plot(np.asarray(self.t), np.asarray(self.data_3_var), '-r', linewidth=3)
            self.ax_3.plot(np.asarray(self.t), np.asarray(self.data_3_kfvar), '-b', linewidth=2)

        # data_4
        if data_4 != None:
            self.ax_4.cla()
            self.ax_4.grid()
            self.ax_4.set_ylabel(r'${\bf P}_{{V_y}{V_y}}$', fontsize=18)
